 ...
 * @package xpdo
 */
class vPDOIterator implements Iterator
{
    private $vpdo = null;
    private $index = 0;
    ...
    private $class = null;
    private $alias;
    /** @var null|int|string|array|vPDOQuery */
    private $criteria = null;
    private $criteriaType = 'vPDOQuery';
     ...
     */
    public function __construct(vPDO &$vpdo, array $options = [])
    {
        $this->vpdo =& $vpdo;
